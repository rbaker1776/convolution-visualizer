...
// Plotter method
function plot_function(func, color)
{
...
function redrawFunctions()
{
    ...
    if (inputGt != false)
    {
        ...
        if (displayGtBox.checked) this.plot_function(gt, getColor("--gt-color"));
    }
    if (inputFt != false)
    {
        ftExtended = evaluate(inputFt, -maxAbsT, maxAbsT, deltaT);
        ft = ftExtended.slice(beginIdx, endIdx);
        if (displayFtBox.checked) this.plot_function(ft, getColor("--ft-color"))
    }
    if (inputFt != false && inputGt != false && displayCvBox.checked)
    {
        ...
        this.plot_function(convolution, getColor("--conv-color"));
    }
}
...
function redrawSliders()
{
    ...
    if (inputGt) this.plot_function(gtBackwards, getColor("--gt-color"));
    if (inputFt) this.plot_function(ft, getColor("--ft-color"));
    if (inputFt && inputGt) this.plot_function(convolution, getColor("--conv-color"));
...
document.addEventListener("DOMContentLoaded", () =>
{
    ...
    slidePlotter.plot_function = plot_function;
